...
movie_genre = MovieGenre.create({genre_id: 3, movie_id: 1})
movie_genre = MovieGenre.create({genre_id: 3, movie_id: 2})
movie_genre = MovieGenre.create({genre_id: 5, movie_id: 2})
movie_genre = MovieGenre.create({genre_id: 4, movie_id: 3})
movie_genre = MovieGenre.create({genre_id: 1, movie_id: 3})
movie_genre = MovieGenre.create({genre_id: 1, movie_id: 4})
movie_genre = MovieGenre.create({genre_id: 4, movie_id: 4})
movie_genre = MovieGenre.create({genre_id: 2, movie_id: 5})
movie_genre = MovieGenre.create({genre_id: 5, movie_id: 5})
movie_genre = MovieGenre.create({genre_id: 1, movie_id: 6})
movie_genre = MovieGenre.create({genre_id: 5, movie_id: 6})
movie_genre = MovieGenre.create({genre_id: 4, movie_id: 6})
